...
def load_training_data():
	...
	location = '/data/chercheurs/qureshi191/preprocessed_data/training_data/text/USE_transformer_embeddings/USE_transformer.npy'
	X = np.load(location)
	...
	X_gender = np.argmax(np.load('/data/chercheurs/qureshi191/preprocessed_data/training_data/gender.npy'), axis=1)
...
def load_development_data():
	...
	location = '/data/chercheurs/qureshi191/preprocessed_data/development_data/text/USE_transformer_embeddings/USE_transformer.npy'
	X = np.load(location)
	...
	X_gender = np.argmax(np.load('/data/chercheurs/qureshi191/preprocessed_data/development_data/gender.npy'), axis=1)
...
def load_test_data():
	...
	location = '/data/chercheurs/qureshi191/preprocessed_data/test_data/text/USE_transformer_embeddings/USE_transformer.npy'
	X = np.load(location)
	...
	X_gender = np.argmax(np.load('/data/chercheurs/qureshi191/preprocessed_data/test_data/gender.npy'), axis=1)
