...
def load_male_model(location=None):
	...
	Y_male = CuDNNLSTM(90, name = 'male_specific_lstm_layer', return_sequences = True)(X)
	Y_shared = CuDNNLSTM(90, name = 'shared_lstm_layer', return_sequences = True)(X)
...
def load_female_model(location=None):
	...
	Y_female = CuDNNLSTM(90, name = 'female_specific_lstm_layer', return_sequences = True)(X)
	Y_shared = CuDNNLSTM(90, name = 'shared_lstm_layer', return_sequences = True)(X)
