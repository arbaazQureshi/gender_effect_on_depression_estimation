...
def load_training_data():
	...
	location = '/data/chercheurs/qureshi191/preprocessed_data/training_data/acoustic/COVAREP/COVAREP.npy'
	X = np.load(location)
...
def load_development_data():
	...
	location = '/data/chercheurs/qureshi191/preprocessed_data/development_data/acoustic/COVAREP/COVAREP.npy'
	X = np.load(location)
...
def load_test_data():
	...
	location = '/data/chercheurs/qureshi191/preprocessed_data/test_data/acoustic/COVAREP/COVAREP.npy'
	X = np.load(location)
