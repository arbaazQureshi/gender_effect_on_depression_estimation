...
while(current_epoch_number <= total_epoch_count):
	...
	for epoch in range(25):
		...
		if(MSE_dev_all < min_MSE_dev_all):
			...
			male_model.save('opton_MSE_dev_all_male_model.h5')
			female_model.save('opton_MSE_dev_all_female_model.h5')
		...
		if(MAE_dev_all < min_MAE_dev_all):
			...
			male_model.save('opton_MAE_dev_all_male_model.h5')
			female_model.save('opton_MAE_dev_all_female_model.h5')
		...
		if(MSE_test_all < min_MSE_test_all):
			...
			male_model.save('opton_MSE_test_all_male_model.h5')
			female_model.save('opton_MSE_test_all_female_model.h5')
		...
		if(MAE_test_all < min_MAE_test_all):
			...
			male_model.save('opton_MAE_test_all_male_model.h5')
			female_model.save('opton_MAE_test_all_female_model.h5')
		...
		if(MSE_dev_male < min_MSE_dev_male):
			...
			male_model.save('opton_MSE_dev_male_male_model.h5')
			female_model.save('opton_MSE_dev_male_female_model.h5')
		...
		if(MAE_dev_male < min_MAE_dev_male):
			...
			male_model.save('opton_MAE_dev_male_male_model.h5')
			female_model.save('opton_MAE_dev_male_female_model.h5')
		...
		if(MSE_test_male < min_MSE_test_male):
			...
			male_model.save('opton_MSE_test_male_male_model.h5')
			female_model.save('opton_MSE_test_male_female_model.h5')
		...
		if(MAE_test_male < min_MAE_test_male):
			...
			male_model.save('opton_MAE_test_male_male_model.h5')
			female_model.save('opton_MAE_test_male_female_model.h5')
		...
		if(MSE_dev_female < min_MSE_dev_female):
			...
			male_model.save('opton_MSE_dev_female_male_model.h5')
			female_model.save('opton_MSE_dev_female_female_model.h5')
		...
		if(MAE_dev_female < min_MAE_dev_female):
			...
			male_model.save('opton_MAE_dev_female_male_model.h5')
			female_model.save('opton_MAE_dev_female_female_model.h5')
		...
		if(MSE_test_female < min_MSE_test_female):
			...
			male_model.save('opton_MSE_test_female_male_model.h5')
			female_model.save('opton_MSE_test_female_female_model.h5')
		...
		if(MAE_test_female < min_MAE_test_female):
			...
			male_model.save('opton_MAE_test_female_male_model.h5')
			female_model.save('opton_MAE_test_female_female_model.h5')
