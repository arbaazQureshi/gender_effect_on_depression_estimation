...
from keras.layers import Dense, CuDNNLSTM, Input, Concatenate, Dropout, Masking, Lambda, BatchNormalization
...
def load_model(location=None):
	...
	Y = CuDNNLSTM(120, name = 'lstm_cell', return_sequences = True)(X)
	...
	Y = Dense(80, activation = 'relu', name = 'regressor_hidden_layer')(Y)
	Y = Dropout(rate = 0.3)(Y)
